...
class GetCommandRequest final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR GetCommandRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void MergeFrom( const GetCommandRequest& from) {
    GetCommandRequest::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
class CmdCutSession final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR CmdCutSession(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class Reboot final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR Reboot(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline ::chunksink::Reboot* Command::release_reboot() {
  ...
  if (_internal_has_reboot()) {
    clear_has_command();
    ::chunksink::Reboot* temp = _impl_.command_.reboot_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.command_.reboot_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::chunksink::Reboot* Command::_internal_mutable_reboot() {
  if (!_internal_has_reboot()) {
    clear_command();
    set_has_reboot();
    _impl_.command_.reboot_ = CreateMaybeMessage< ::chunksink::Reboot >(GetArenaForAllocation());
  }
  return _impl_.command_.reboot_;
}
...
inline void Command::set_has_cmdcutsession() {
  _impl_._oneof_case_[0] = kCmdCutSession;
}
...
inline ::chunksink::CmdCutSession* Command::release_cmdcutsession() {
  ...
  if (_internal_has_cmdcutsession()) {
    clear_has_command();
    ::chunksink::CmdCutSession* temp = _impl_.command_.cmdcutsession_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.command_.cmdcutsession_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::chunksink::CmdCutSession* Command::_internal_mutable_cmdcutsession() {
  if (!_internal_has_cmdcutsession()) {
    clear_command();
    set_has_cmdcutsession();
    _impl_.command_.cmdcutsession_ = CreateMaybeMessage< ::chunksink::CmdCutSession >(GetArenaForAllocation());
  }
  return _impl_.command_.cmdcutsession_;
}
