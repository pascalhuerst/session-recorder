...
struct RecorderStatusDefaultTypeInternal {
  PROTOBUF_CONSTEXPR RecorderStatusDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 RecorderStatusDefaultTypeInternal _RecorderStatus_default_instance_;
...
struct ResponeDefaultTypeInternal {
  PROTOBUF_CONSTEXPR ResponeDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ResponeDefaultTypeInternal _Respone_default_instance_;
}  // namespace common
...
const ::_pbi::DescriptorTable descriptor_table_common_2eproto = {
    false, false, 343, descriptor_table_protodef_common_2eproto,
    "common.proto",
...
uint8_t* RecorderStatus::_InternalSerialize(
  ...
  if (raw_rmspercent != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(4, this->_internal_rmspercent(), target);
  }

  // bool clipping = 5;
  if (this->_internal_clipping() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(5, this->_internal_clipping(), target);
  }
