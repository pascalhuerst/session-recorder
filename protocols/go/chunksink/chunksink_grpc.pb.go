...
const (
	ChunkSink_StreamChunkData_FullMethodName   = "/chunksink.ChunkSink/StreamChunkData"
...
func (c *chunkSinkClient) StreamChunkData(ctx context.Context, in *StreamChunkDataRequest, opts ...grpc.CallOption) (ChunkSink_StreamChunkDataClient, error) {
	stream, err := c.cc.NewStream(ctx, &ChunkSink_ServiceDesc.Streams[0], ChunkSink_StreamChunkData_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *chunkSinkClient) SetRecorderStatus(ctx context.Context, in *RecorderStatusRequest, opts ...grpc.CallOption) (*RecorderStatusReply, error) {
	...
	err := c.cc.Invoke(ctx, ChunkSink_SetRecorderStatus_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
