...
func (UnimplementedChunkSinkServer) SetRecorderStatus(context.Context, *common.RecorderStatus) (*common.Respone, error) {
	return nil, status.Error(codes.Unimplemented, "method SetRecorderStatus not implemented")
}
func (UnimplementedChunkSinkServer) SetChunks(context.Context, *Chunks) (*common.Respone, error) {
	return nil, status.Error(codes.Unimplemented, "method SetChunks not implemented")
}
func (UnimplementedChunkSinkServer) GetCommands(*GetCommandRequest, grpc.ServerStreamingServer[Command]) error {
	return status.Error(codes.Unimplemented, "method GetCommands not implemented")
}
...
func RegisterChunkSinkServer(s grpc.ServiceRegistrar, srv ChunkSinkServer) {
	// If the following call panics, it indicates UnimplementedChunkSinkServer was
