...
type SessionSourceClient interface {
	...
	StreamSessionAudio(ctx context.Context, in *StreamSessionAudioRequest, opts ...grpc.CallOption) (SessionSource_StreamSessionAudioClient, error)
	// Unary
...
func (c *sessionSourceClient) StreamSessionAudio(ctx context.Context, in *StreamSessionAudioRequest, opts ...grpc.CallOption) (SessionSource_StreamSessionAudioClient, error) {
	stream, err := c.cc.NewStream(ctx, &SessionSource_ServiceDesc.Streams[2], "/sessionsource.SessionSource/StreamSessionAudio", opts...)
	if err != nil {
		return nil, err
	}
	x := &sessionSourceStreamSessionAudioClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type SessionSource_StreamSessionAudioClient interface {
	Recv() (*AudioChunk, error)
	grpc.ClientStream
}

type sessionSourceStreamSessionAudioClient struct {
	grpc.ClientStream
}

func (x *sessionSourceStreamSessionAudioClient) Recv() (*AudioChunk, error) {
	m := new(AudioChunk)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *sessionSourceClient) ShareSession(ctx context.Context, in *ShareSessionRequest, opts ...grpc.CallOption) (*common.Respone, error) {
	out := new(common.Respone)
	err := c.cc.Invoke(ctx, "/sessionsource.SessionSource/ShareSession", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sessionSourceClient) ShareSegment(ctx context.Context, in *ShareSegmentRequest, opts ...grpc.CallOption) (*common.Respone, error) {
	out := new(common.Respone)
	err := c.cc.Invoke(ctx, "/sessionsource.SessionSource/ShareSegment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SessionSourceServer interface {
	...
	StreamSessionAudio(*StreamSessionAudioRequest, SessionSource_StreamSessionAudioServer) error
	// Unary
...
func (UnimplementedSessionSourceServer) StreamSessionAudio(*StreamSessionAudioRequest, SessionSource_StreamSessionAudioServer) error {
...
func _SessionSource_StreamSessionAudio_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(SessionSourceServer).StreamSessionAudio(m, &sessionSourceStreamSessionAudioServer{stream})
}

type SessionSource_StreamSessionAudioServer interface {
	Send(*AudioChunk) error
	grpc.ServerStream
}

type sessionSourceStreamSessionAudioServer struct {
	grpc.ServerStream
}

func (x *sessionSourceStreamSessionAudioServer) Send(m *AudioChunk) error {
	return x.ServerStream.SendMsg(m)
}
...
func _SessionSource_ShareSession_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sessionsource.SessionSource/ShareSession",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SessionSource_ShareSegment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sessionsource.SessionSource/ShareSegment",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
