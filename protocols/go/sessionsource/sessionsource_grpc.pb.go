...
const (
	...
	SessionSource_StreamWaveformPeaks_FullMethodName = "/sessionsource.SessionSource/StreamWaveformPeaks"
...
type SessionSourceClient interface {
	...
	StreamWaveformPeaks(ctx context.Context, in *StreamWaveformPeaksRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[WaveformPeakData], error)
	// Unary
	...
	RetryRenderSession(ctx context.Context, in *RetryRenderSessionRequest, opts ...grpc.CallOption) (*common.Respone, error)
...
func (c *sessionSourceClient) StreamWaveformPeaks(ctx context.Context, in *StreamWaveformPeaksRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[WaveformPeakData], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &SessionSource_ServiceDesc.Streams[3], SessionSource_StreamWaveformPeaks_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[StreamWaveformPeaksRequest, WaveformPeakData]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type SessionSource_StreamWaveformPeaksClient = grpc.ServerStreamingClient[WaveformPeakData]
...
func (c *sessionSourceClient) RetryRenderSession(ctx context.Context, in *RetryRenderSessionRequest, opts ...grpc.CallOption) (*common.Respone, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(common.Respone)
...
type SessionSourceServer interface {
	...
	StreamWaveformPeaks(*StreamWaveformPeaksRequest, grpc.ServerStreamingServer[WaveformPeakData]) error
	// Unary
	...
	RetryRenderSession(context.Context, *RetryRenderSessionRequest) (*common.Respone, error)
...
func (UnimplementedSessionSourceServer) StreamWaveformPeaks(*StreamWaveformPeaksRequest, grpc.ServerStreamingServer[WaveformPeakData]) error {
	return status.Errorf(codes.Unimplemented, "method StreamWaveformPeaks not implemented")
}
...
func (UnimplementedSessionSourceServer) RetryRenderSession(context.Context, *RetryRenderSessionRequest) (*common.Respone, error) {
...
func _SessionSource_StreamWaveformPeaks_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(StreamWaveformPeaksRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(SessionSourceServer).StreamWaveformPeaks(m, &grpc.GenericServerStream[StreamWaveformPeaksRequest, WaveformPeakData]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type SessionSource_StreamWaveformPeaksServer = grpc.ServerStreamingServer[WaveformPeakData]
...
func _SessionSource_RetryRenderSession_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RetryRenderSessionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SessionSourceServer).RetryRenderSession(ctx, req.(*RetryRenderSessionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SessionSource_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "StreamWaveformPeaks",
			Handler:       _SessionSource_StreamWaveformPeaks_Handler,
			ServerStreams: true,
		},
	},
